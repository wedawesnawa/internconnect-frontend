...
* Managing multiple user roles with different permissions and responsibilities.
* Designing an approval workflow between students, academic supervisors, and industry mentors.
* Synchronizing internship activity records in real time.
...
* External API integration (Whereby)
...
* Analytics dashboard for internship performance
...
### Publication: 
[Penerapan Sistem Berbasis Web untuk Meningkatkan Efektivitas Monitoring dan Evaluasi Praktek Kerja Lapangan di PT. Sanata System](https://ejournal1.unud.ac.id/index.php/jupita/article/view/1759)
